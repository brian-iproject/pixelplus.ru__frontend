        ...
        if (typeof intlTelInput !== 'undefined') {
            ...
            inputsPhone.forEach(input => {
                intlTelInput(input, {
                    ...
                    initialCountry: "auto",
                    onlyCountries: ['ru', 'by', 'kz', 'am', 'az', 'kg', 'md', 'tj', 'uz', 'ge', 'ua',
                                    'us', 'at', 'be', 'bg', 'gb', 'hu', 'de', 'gr', 'dk', 'ie', 'is',
                                    'es', 'it', 'lv', 'lt', 'nl', 'no', 'pl', 'pt', 'ro', 'rs', 'sk',
                                    'si', 'fi', 'fr', 'hr', 'me', 'cz', 'ch', 'se', 'ee', 'ae'],
                    //strictMode: true,
                    nationalMode: false,
            ...
            on: {
                ...
                afterSet: () => {
                    if (typeof LoadScripts !== 'undefined') {
                        new LoadScripts([
                            {
                                html: `<script type="text/javascript" > (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date(); for (var j = 0; j < document.scripts.length; j++) {if (document.scripts[j].src === r) { return; }} k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}) (window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym"); ym(11819104, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true, trackHash:true }); </script> <noscript><div><img src="https://mc.yandex.ru/watch/11819104" style="position:absolute; left:-9999px;" alt="" /></div></noscript>`,
                                areaSelector: '#loadCounters'
                            },
                            {
