        ...
        pdfButton.addEventListener('click', () => {
            ...
            setTimeout(() => { // чтобы график успел анимироваться, else: пустой скриншот
                const snapshot1 = new Promise((resolve) => {
                    html2canvas(this.container.querySelector('.js-traffic-forecast-traffic-chart'))
                        .then((canvas) => {
                ...
                const snapshot2 = new Promise((resolve) => {
                    html2canvas(this.container.querySelector('.js-traffic-forecast-sales-chart'))
                        .then((canvas) => {
